...
export const experiences: Experience[] = [
  {
    ...
    After the rise in popularity of LLMs, I started working on the integration of Copilot in OneDrive and SharePoint, shipping the capabilities of getting QnA on specific files, or based on specific scoped content.
...
`,
  },
  {
    ...
    description: `My Engineering studies are a bit complicated :) I Majored in Mathematical Engineering with a Minor in Programming. But my Engineer Title is in Computer Science.
    
    During my last semester, as I took more advance courses, I started to enjoy studying the "bleeding edge" a lot.
    I got to read \`Attention Is All You Need\` in 2018, and loved the idea of comparing competing ideas that could better simulate semantic comprehension.
    All this made me opt for taking my Master's with PUC's AI Lab.
